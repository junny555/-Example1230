...
public class MemberController extends HttpServlet {
	...
	//	System.out.println("가상경로는"+str);
		...
		if (str.equals("/member/memberList.do")) {  //추출한 가상경로가 이문자열과 같나요?
			...
			MemberDao md = new MemberDao();
			int value= md.memberInsert(memberId,memberPwd,memberName,memberPhone,memberEmail, memberGender,memberAddr,memberBirth);
			...
			else if (str.equals("/member/memberLoginOut.do")) {
		System.out.println("로그아웃 두 ㅇㅋ");
		...
		}else if(str.equals("/member/memberLoginAction")) {
			String memberId=request.getParameter("memberId");
			String memberPwd = request.getParameter("memberPwd");
